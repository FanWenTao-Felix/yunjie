...
<basic-container>
  ...
  <el-dialog title="费用详情" :visible.sync="detail_show" width="90%" top="4vh" align="center">
    <div v-if="detail_type==0">
      <fee v-if="detail_show" :internalOrderNo="detail_internalOrderNo" :canEdit="true" />
    </div>
    <div v-if="detail_type==1">
      <additionfee :internalOrderNo="detail_internalOrderNo" :canEdit="true" />
    </div>
  </el-dialog>
</basic-container>
</template>
...
import additionfee from "../ocean/seafee.vue"
export default {
  data() {
    return {
      detail_type: 0,
