...
<script>
  import {getList, getDetail, add, update, remove, getListdetail, airdetail, seadetail} from "@/api/statistics/businesstatistics";
  ...
  export default {
    ...
    methods: {
      ...
      onLoaddetail(page, params = {}) {
        var num=this.detail_internalOrderNo;
        this.loading = true;
        getListdetail(page.currentPage, page.pageSize, Object.assign(params, this.query),num).then(res => {
          const data = res.data.data;
          this.page.total = data.total;
