...
<basic-container>
  <avue-crud :option="option" :table-loading="loading" :data="data" :page="page" :permission="permissionList" :before-open="beforeOpen" v-model="form" ref="crud" @row-update="rowUpdate" @row-save="rowSave" @row-del="rowDel" @search-change="searchChange"
    ...
    <template slot="menuLeft">
      <el-button type="danger" size="small" icon="el-icon-delete" plain v-if="permission.supplier_delete" @click="handleDelete">删 除
      </el-button>
      <el-button type="primary" icon="el-icon-download" @click="batchExport" size="small">导出 </el-button>
      <el-col :span="7.5">
        <el-upload :headers="uploadHeaders" class="upload-demo" :on-progress="batchImportProgress" action="/api/client/supplier/batchImport" :limit="1" :before-upload="beforeBatchImport" :on-success="batchImportSuccess" :file-list="fileList">
...
export default {
  ...
  methods: {
    batchExport: function() {
      ...
      var href = "/api/client/supplier/batchExport";
